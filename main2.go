...
func New2(DB *gorm.DB, netConfig NetConfig, tlgConfig TelegramConfig) (*MeansBot2, error) {
	if DB == nil {
		return &MeansBot2{}, fmt.Errorf("No db connection given")
	}
	bot, err := tgbotapi.NewBotAPI(tlgConfig.BotToken)
	if err != nil {
		return &MeansBot2{}, err
	}
...
func (ui *MeansBot2) Stop() {
	ui.stopChan <- struct{}{}
}

//Run starts updates handling
func (ui *MeansBot2) Run(handlersProvider ActionHandlersProvider, templateDir string) error {
